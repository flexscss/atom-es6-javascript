...
module.exports =
  ...
  activate: (state) ->
    atom.commands.add 'atom-text-editor',
      'es6-typescript:end-line': => @endLine(';', false)
    atom.commands.add 'atom-text-editor',
      'es6-typescript:end-line-comma': => @endLine(',', false)
    atom.commands.add 'atom-text-editor',
      'es6-typescript:end-new-line': => @endLine('', true)
    atom.commands.add 'atom-text-editor',
      'es6-typescript:wrap-block': => @wrapBlock()
